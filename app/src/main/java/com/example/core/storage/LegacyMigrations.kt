...
object LegacyMigrations {
    ...
    val MIGRATION_5_6 = object : Migration(5, 6) {
        override fun migrate(db: SupportSQLiteDatabase) {
            try { db.execSQL("ALTER TABLE ledger_events ADD COLUMN reason TEXT NOT NULL DEFAULT ''") } catch (_: Exception) {}
            try { db.execSQL("ALTER TABLE ledger_events ADD COLUMN referenceEntityId TEXT NOT NULL DEFAULT ''") } catch (_: Exception) {}
